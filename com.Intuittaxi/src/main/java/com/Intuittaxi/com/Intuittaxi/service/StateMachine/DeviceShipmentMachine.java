...
@Slf4j
@Service
public class DeviceShipmentMachine implements StateMachine{
    ...
    public ProfileCurrentState processState(Documents documents) {
        ...
        // if failed return ProfileCurrentState.DEVICE_SHIPMENT
        // else
        log.info("Moving processing step from DeviceShipmentMachine to TraningExecuterMachine");
